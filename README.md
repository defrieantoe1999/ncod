...
# Slam Mirror Bot (enchanced)
This is a Telegram bot writen in Python for mirroring files on the Internet to our beloved Google Drive.
![GitHub Repo stars](https://img.shields.io/github/stars/Ncode2014/slam-mirrorbot?color=blue&style=flat)
...
![GitHub pull requests](https://img.shields.io/github/issues-pr/Ncode2014/slam-mirrorbot)
...
![GitHub repo size](https://img.shields.io/github/repo-size/Ncode2014/slam-mirrorbot?color=red)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/Ncode2014/slam-mirrorbot)
[![Slam Mirror Support](https://img.shields.io/badge/slam%20mirror%20bot-support%20group-blue)](https://t.me/SlamMirrorSupport)

**Slam Mirror Bot (enchaned)** is a Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive.

## What is different this from slam 
- Ffmpeg Custom and Aria Patch
- Extreme Configuration Aria
- Rclone Support
- Change YT-DL to YT-DLP
- Keep Upstream From Slam

# Features supported:

## Additional Features From Slam 
...
- Clone this repo:
```
git clone https://github.com/Ncode2014/slam-mirrorbot mirrorbot/
cd mirrorbot
```
...
- [Slam-mirrorbot](https://github.com/breakdowns/slam-mirrorbot) for base repo 
